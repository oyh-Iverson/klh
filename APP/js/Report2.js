...
//				},
				...
				detailsClick(id,n,name){
                   ...
                   var urlStr = Util.baseUrl + '/DuG/api/user/user/saveFunctionClick.do';
					...
					console.log(userID);
					var functionNum="为您推荐_查信用_"+name;
					var sourceType= "1";
            			...
            			data: [{
              				...
              				itemStyle: {
                				normal: {
                  					color: {  // 完成的圆环的颜色
                    					colorStops: [{
                      						offset: 0, color: '#55ae6b' // 0% 处的颜色
                    					},
                    					{
                      						offset: 1, color: '#55ae6b' // 100% 处的颜色
                    					}]
                  					},
                  					label: {
                    					show: false
...
//							}
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if (res.ret_code == '0') {   
                         var data = res.ret_data.slice(0,6); //前面6个拿来放一个数组中
                         //console.log(data);
...
//                       console.log(bb);
                         for(var i = 0;i<data.length;i++){
                            ...
                            self.daikuanList = res.ret_data.slice(0,6); 
